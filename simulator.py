...
class Simulator:
    ''' - class to contain the simulator 
        - author: Abhjeet Verma '''
    ...
    def getSimulationSpace(self, master):
        ...
        '''
        !!!!! Although this isn't useful here, you can place any one widget inside canvas in follwing way, so, you can place a frame and place widgets inside it
        self.simulationSpace.create_window(300, 300, tags = 'myWindow', window = tk.Label(text = 'hi'))
        master.update_idletasks()
        print('({}x{})'.format(master.winfo_vrootheight(), master.winfo_screenwidth()))  # DEBUG
        print(master.winfo_geometry())  # DEBUG
        '''
